...
# Семантический поиск без ИИ: character n-gram hashing + cosine
# ═════════════════════════════════════════════════════════════
EMBED_URL = os.environ.get("MEMORY_WIKI_EMBED_URL", "http://127.0.0.1:4000")
    ...
    def _backup(self, reason: str='manual') -> Dict[str, Any]:
        ...
        try:
            with zipfile.ZipFile(tmp_path, 'w', zipfile.ZIP_DEFLATED) as z:
                ...
                z.writestr('backup_meta.json', json.dumps({'id':bid,'reason':reason,'created_at':now(),'version':'1.4.0-journal','files':len(written)}, ensure_ascii=False, indent=2))
