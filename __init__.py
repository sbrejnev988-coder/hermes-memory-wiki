...
class MemoryWikiProvider(MemoryProvider):
    ...
    def get_tool_schemas(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            {"name":"memory_wiki_immune_scan","description":"Memory immune system: detect and apply fixes for secrets, unprocessed entries, and stale claims.","parameters":P({"mode":{"type":"string","enum":["suggest","apply"],"default":"suggest"},"limit":{"type":"integer","default":100}})},
